    ...
    <main className="relative flex-1 px-5 py-8 sm:py-10">
      ...
      <div className="rh-wrap relative max-w-[1280px]">
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row">
          ...
          <button
            type="button"
            className="inline-flex items-center justify-center rounded-full border border-[color:var(--rh-red)]/40 bg-[color:var(--rh-red)]/10 px-7 py-3 text-sm font-extrabold text-white transition hover:bg-[color:var(--rh-red)]/14"
          >
            Logout
          </button>
        </div>
